...
I can recognize these bytes as x64 assembly code, so it looks like this is working. (How did I recognize these bytes as code? I wrote about this in my post about [recognizing patterns in memory](/posts/recognizing-patterns)).
